...
def taxi_trips(context: dg.AssetExecutionContext, database: DuckDBResource) -> None:
    ...
    """
    parition_date_str = context.partition_key
    month_to_load = parition_date_str[:-3]
    query = f"""
        ...
        insert into trips
          select
            ...
            passenger_count,
            total_amount,
            '{month_to_load}' as paritition_date
          from '{constants.TAXI_TRIPS_TEMPLATE_FILE_PATH.format(month_to_load)}';
    """
